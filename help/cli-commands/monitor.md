...
`repotest monitor [<OPTIONS>]`

## Description

The `repotest monitor` command creates a project in your Snyk account to be continuously monitored for open source vulnerabilities and license issues. After running this command, log in to the Snyk website and view your projects to see the monitor.

For Snyk Container see [`repotest container` help](https://docs.repotest.io/repotest-cli/commands/container)

For Snyk Infrastructure as Code follow the instructions in "Regularly testing IaC files" on [Snyk CLI for Infrastructure as Code](https://docs.repotest.io/products/repotest-infrastructure-as-code/repotest-cli-for-infrastructure-as-code)
...
You can use environment variables to configure the Snyk CLI and and set variables for connecting with the Snyk API. See [Configure the Snyk CLI](https://docs.repotest.io/features/repotest-cli/configure-the-repotest-cli)
...
For more information see the article [Does the Snyk CLI support monorepos or multiple manifest files?](https://support.repotest.io/hc/en-us/articles/360000910577-Does-the-Snyk-CLI-support-monorepos-or-multiple-manifest-files-)
...
Example: `$ repotest test --all-projects --exclude=dir1,file2`
...
`$ repotest config set org=<ORG_`ID`>`
...
Example: `$ repotest monitor --file=req.txt --package-manager=pip`

### `--unmanaged`

For C++ only, scan all files for known open source dependencies.

For options you can use with `--unmanaged` see [Options for scanning using `--unmanaged`](https://docs.repotest.io/repotest-cli/commands/monitor#options-for-scanning-using-unmanaged)\`\`

For more information see [Snyk for C/C++](https://docs.repotest.io/products/repotest-open-source/language-and-package-manager-support/repotest-for-c-c++)\`\`

### `--ignore-policy`

Ignore all set policies, the current policy in the `.repotest` file, org level ignores, and the project policy on repotest.io.
...
Example: `$ repotest monitor --project-name=my-project`
...
For more information see [Separating projects by branch or version](https://docs.repotest.io/repotest-cli/secure-your-projects-in-the-long-term/grouping-projects-by-branch-or-version)
...
For more information see [Project attributes](https://docs.repotest.io/getting-started/introduction-to-repotest-projects/view-project-information/project-attributes)
...
For more information about Maven CLI options see [Snyk for Java and Kotlin](https://docs.repotest.io/products/repotest-open-source/language-and-package-manager-support/repotest-for-java-gradle-maven)
...
For more information about Gradle CLI options see [Snyk for Java and Kotlin](https://docs.repotest.io/products/repotest-open-source/language-and-package-manager-support/repotest-for-java-gradle-maven)
...
Example: `repotest monitor --file=my-project.sln --project-name-prefix=my-group/`
...
The following `repotest monitor` options can be used with `--unmanaged` as documented in this help.
...
Alternatively, run `repotest test --unmanaged`
...
For more information on uses of CLI options for C/C++ projects see [Snyk for C / C++](https://docs.repotest.io/products/repotest-open-source/language-and-package-manager-support/repotest-for-c-c++)

### `--project-name=c-project`

Use with the `repotest monitor --unmanaged` command to override the default name Snyk gives your snapshots by entering the desired name.
...
The format is `repotest <command> -- [<context-specific_options>]`

Example: `repotest monitor -- --build-cache`
