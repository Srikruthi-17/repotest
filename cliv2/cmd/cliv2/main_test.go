...
import (
	...
	main "github.com/repotest/cli/cliv2/cmd/cliv2"
...
func Test_GetConfiguration(t *testing.T) {
	cmd := "_bin/repotest_darwin_arm64 --debug --proxy-negotiate --proxy=http://host.example.com:3128 --insecure test"
	...
	expectedArgs := []string{"_bin/repotest_darwin_arm64", "--debug", "--insecure", "test"}
