...
import (
	...
	"github.com/repotest/cli/cliv2/internal/proxy"
...
func Test_canGoThroughProxy(t *testing.T) {
	...
	res, err := proxiedClient.Get("https://static.repotest.io/cli/latest/version")
	if err != nil {
		t.Fatal(err)
	}
...
func Test_xSnykCliVersionHeaderIsReplaced(t *testing.T) {
	...
	ts := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		capturedVersion = r.Header.Get("x-repotest-cli-version")
	}))
	defer ts.Close()
	...
	req.Header.Add("x-repotest-cli-version", "1.0.0")
...
func Test_SetUpstreamProxy(t *testing.T) {
	...
	testUrl, _ := url.Parse("https://www.repotest.io")
