import { DepGraphData } from '@repotest/dep-graph';
...
/* Test Result
 * this data is returned on a `repotest test` for supported project types
...
// defining only what is used by @repotest/fix
// add more as needed
