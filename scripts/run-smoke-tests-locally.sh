...
echo "Attempting to run Smoke Tests locally. See file 'test/smoke/README.md' for details. This will drop your local 'repotest config'!"
...
SNYK_COMMAND="node ${PWD}/bin/repotest" REGRESSION_TEST=1 SMOKE_TESTS_SKIP_TEST_THAT_OPENS_BROWSER=1 SMOKE_TESTS_SNYK_TOKEN=$SNYK_API_TOKEN shellspec --chdir test/smoke test/smoke/spec/repotest_auth_spec.sh -f d
