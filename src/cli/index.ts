...
import { LegacyVulnApiResult, TestResult } from '../../../lib/repotest-test/legacy';
...
import { FailOn } from '../../../lib/repotest-test/common';
import {
...
export default async function test(
  ...
  analytics.add(
    'upgradable-repotest-protect-paths',
  ...
  // TODO remove once https://github.com/repotest/cli/pull/3433 is merged
  ...
  for (const path of paths) {
    ...
    try {
      res = await repotest.test(path, testOpts);
    } catch (error) {
