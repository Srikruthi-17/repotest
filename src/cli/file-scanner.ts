...
import { SEVERITIES } from '../../../../../lib/repotest-test/common';
...
export class FailedToBuildPolicyEngine extends CustomError {
  constructor(message?: string) {
    ...
    this.userMessage =
      'We were unable to run the test. Please run the command again with the `-d` flag and contact support@repotest.io with the contents of the output';
  }
}
