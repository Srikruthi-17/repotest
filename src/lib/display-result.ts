...
import { TestResult } from '../../../lib/repotest-test/legacy';
import { IacTestResponse } from '../../../lib/repotest-test/iac-test-result';
...
export function displayResult(
  ...
  if (res.ok && res.vulnerabilities.length === 0) {
    ...
    return (
      ...
      (isCI()
        ? ''
        : dockerAdvice + nextStepsText + repotestPackageTestTip + dockerCTA)
    );
  }
