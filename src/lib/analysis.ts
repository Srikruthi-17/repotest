...
const debug = debugLib('repotest-code');
...
function validateLocalCodeEngineUrl(localCodeEngineUrl: string): void {
  if (localCodeEngineUrl.length === 0) {
    throw new MissingConfigurationError(
      'Snyk Code Local Engine. Refer to our docs on https://docs.repotest.io/products/repotest-code/deployment-options/repotest-code-local-engine/cli-and-ide to learn more',
    );
  }
}
