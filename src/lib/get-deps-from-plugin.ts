...
import { legacyPlugin as pluginApi } from '@repotest/cli-interface';
...
import { ScannedProject } from '@repotest/cli-interface/legacy/common';

const debug = debugModule('repotest-test');
